...
if __name__ == "__main__":
    ...
    plt.plot(x,hr_dgcnn,color='red',linewidth=2,
            linestyle='solid',label='HR Ours - {:.2f}%'.format(hr_dgcnn[9]))
    plt.plot(x,ws_dgcnn,color='blue',linewidth=2,
            linestyle='solid',label='WS Ours - {:.2f}%'.format(ws_dgcnn[9]))
    plt.plot(x,us_dgcnn,color='green',linewidth=2,
             linestyle='solid',label='US Ours - {:.2f}%'.format(us_dgcnn[9]))
    
    plt.plot(x,hr_2d,color='red',linewidth=2,
            linestyle='dashed',label='HR ES - {:.2f}%'.format(hr_2d[9]))
    plt.plot(x,ws_2d,color='blue',linewidth=2,
            linestyle='dashed',label='WS ES - {:.2f}%'.format(ws_2d[9]))
    plt.plot(x,us_2d,color='green',linewidth=2,
        linestyle='dashed',label='US ES - {:.2f}%'.format(us_2d[9]))
    ...
    plt.plot(x,hr_100,color='red',linewidth=2,
            linestyle='solid',label='HR No-Culling - {:.2f}%'.format(hr_100[9]))
    plt.plot(x,ws_100,color='blue',linewidth=2,
            linestyle='solid',label='WS No-Culling - {:.2f}%'.format(ws_100[9]))
    plt.plot(x,us_100,color='green',linewidth=2,
             linestyle='solid',label='US No-Culling - {:.2f}%'.format(us_100[9]))
    
    plt.plot(x,hr_50,color='red',linewidth=2,
            linestyle='dashed',label='HR Culling - {:.2f}%'.format(hr_50[9]))
    plt.plot(x,ws_50,color='blue',linewidth=2,
            linestyle='dashed',label='WS Culling - {:.2f}%'.format(ws_50[9]))
    plt.plot(x,us_50,color='green',linewidth=2,
        linestyle='dashed',label='US Culling - {:.2f}%'.format(us_50[9]))
