...
class Tile(torch.nn.Module):
    def __init__(self, out_channels, tile_size, use_polar=False):
        ...
        self.upsample_8x = nn.ConvTranspose2d(out_channels, out_channels, 16, 8, 4, bias=False)
        self.upsample_8x.weight.data = bilinear_kernel(out_channels, out_channels, 16)
