""" This file saves examples used to generate videos for the route-based localization """
import os
import sys
...
if __name__ == "__main__":
    ...
    key_frame = save_for_vis['save_for_vis'][2] # change here: 0-gt, 1-es, 2-mes
    ...
    # save tile for animation_route.py
    ...
    for idx in key_frame:
        ...
        cv2.imwrite(os.path.join('video',area,str(idx)+'_mes.jpg'),tile) # change output file name here
