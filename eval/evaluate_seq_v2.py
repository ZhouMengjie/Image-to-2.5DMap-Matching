...
def evaluate(model, device, params, exp_name, pca_dim):
    ...
    for location_name in params.eval_files:
        ...
        val_collate_fn = make_collate_fn(datasets[location_name])
        dataloaders[location_name] = DataLoader(datasets[location_name], batch_size=params.val_batch_size, num_workers=nw, pin_memory=True, shuffle=False, drop_last=False, collate_fn=val_collate_fn)
