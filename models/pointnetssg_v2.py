...
class PointNetSSG(nn.Module):
    ...
    def forward(self, batch):
        ...
        # projection module
        x1 = F.adaptive_max_pool1d(l3_points, 1).view(batch_size, -1)           # (batch_size, emb_dims, num_points) -> (batch_size, emb_dims)
        x2 = F.adaptive_avg_pool1d(l3_points, 1).view(batch_size, -1)           # (batch_size, emb_dims, num_points) -> (batch_size, emb_dims)
        x = torch.cat((x1, x2), 1)  
        return x, l3_points, xyz_o, center
